<head>
  ...
  function createNewElementExplo() {
    ...
    <form action="{{ route('exploreTechs.store') }}" method="POST">
      ...
      <div style="display:flex;justify-content:space-around;align-items:center;">
        <button class="cancel delete" type="button" onclick="cancelNewElementExplo(this)">Cancel</button>
  ...
  `;
    ...
    function cancelNewElementExplo(cancelButton) {
      const newExploElement = cancelButton.closest('.tCards');
      newExploElement.remove();
    }
  </script>
</head>
...
<section id="exploreTech" style="border: 2px solid cornflowerblue;margin-bottom:2rem;background-color:antiquewhite;">
  <h2>Explore Tech</h2>
  <button class="create" onclick="createNewElementExplo()">Create <i class="fas fa-plus"></i></button>
  <div id="techCards">
