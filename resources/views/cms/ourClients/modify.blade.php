    ...
    newClientElement.innerHTML = `
        <form action="{{ route('ourClients.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div style="margin-top:1rem;display:inline-flex;flex-direction:column;">
            ...
            <button style="margin-top:1rem;" class="Create" type="submit">Save New element</button>
          </div>
        </form>
      `;
...
<div style="border: 2px solid cornflowerblue;margin:2rem;">
  <h2 style="margin:2rem;">Our Clients</h2>
  <section id="ourClients" style="display:flex;flex-wrap:wrap;">
    ...
    @endforeach
    <button class="create" onclick="createNewElementClient()">Click to Create a new client element.</button>
  </section>
</div>
