<style>
  #contact #cMapForm #cDetails .spanA {
    margin-bottom: 0.5rem;
    color: #4682B4;
    font-size: 0.9rem;
  }
  #contact #cMapForm #cDetails .spanB {
    margin-bottom: 1rem;
    font-size: 0.9rem;
  }
</style>
  ...
  <div id="cMapForm" class="d-flex">
    ...
    <div class="col-md-7 gmap">
      <iframe
        ...
        style="min-width:100%;border:0;height:100%;" allowfullscreen="false" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>

    <div id="cDetails" class="col-md-5 p-5 d-flex flex-column">
      <h5 class="mb-4">Shangrila Microsystem</h5>
